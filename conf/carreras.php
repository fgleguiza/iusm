...
    		</div>
        ...
            <div id="ciclo" class="tab-pane fade">
            ...
            <div id="posgrado" class="tab-pane fade">
                    <p style="text-align: justify"><?php echo $row;
                while($row=sql_do_array($result3))  { ?>
                        <div class="container" style="padding-top: 25px; padding-bottom:25px; border-bottom: 1px solid rgba(0,0,0,0.3);">
                            <div class="row">
                                <div class="col-lg-2 text-center d-flex align-items-center justify-content-center">
                                    <img class="img-fluid" style="max-height:200px; padding-bottom: 20px;" src="img/escudos/<?php echo $row['SCHOOL'];?>.png">
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-3" align="center">
      ...
      <button class="btn btn-sm btn-outline-light btn-block" onClick="location.href='<?php echo $pagina_web; ?>'" style="border: 1px solid white; background-color: transparent; color: white; border-radius: 5px"> M&aacute;s informaci&oacute;n </button>
      <br>
      <br>
	 ...
	 <div class="col-md-6">
      ...
      <p class="small text-light">Direcci&oacute;n de Educaci&oacute;n<br>Juan Díaz de Solís 2371 <br>Olivos, Buenos Aires, Argentina </p>
      ...
      <p>
        ...
        <a href="" class="pictogramapie"><i class="fa fa-linkedin-square"></i></a>
