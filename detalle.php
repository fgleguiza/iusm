<?php
	...
	if($row['SCHOOL'] == "AEOF") {
		$sede = "Instituto de Formación (IFOR) - Departamento Académico Escuela de Oficiales (AEOF), Zárate, Provincia de Buenos Aires.";
	}
	if($row['SCHOOL'] == "AESU") {
		$sede = "Instituto de Formación (IFOR) - Departamento Académico Escuela de Suboficiales (AESU), Zárate, Provincia de Buenos Aires.";
	}
	if($row['SCHOOL'] == "ESIN") {
		$sede = "Escuela Superior de Informática (ESIN), Olivos, Provincia de Buenos Aires.";
	}
	if($row['SCHOOL'] == "IFDO") {
		$sede = "Instituto de Formación, Capacitación, Perfeccionamiento y Actualización Docente (IFDO), Zárate y Olivos, Provincia de Buenos Aires.";
	}
	if($row['SCHOOL'] == "ESUP") {
		$sede = "Escuela Superior (ESUP) Olivos, Provincia de Buenos Aires.";
	}
        ...
              
				<div id="presentación" class="tab-pane fade in active">
					<p style="text-align: justify">
						...
						<b>Duración:</b> <?php echo $carga." horas en ".$duracion." a&ntilde;os";?> <br>
						<br>
...
<div class="container-fluid home-footer" style="padding: 0px; background-color: #343A40; color: white; padding-top: 110px">
<br><br>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-3" align="center">
	 ...
	 <div class="col-md-6">
      <h5 class="text-light" style="margin-top: 0px;">CONTACTO</h5>
      ...
      <p class="text-light small"><i class="icono-arg-telefono-neg"></i> +54 11 4512 1014</p>
		<p class="text-light small"><i class="fa fa-envelope"></i> informes@iusm.edu.ar </p>
		<p class="text-light small"><i class="fa fa-link"></i> https://prefecturanaval.gob.ar</p>
      <br>
		  
      <h5 class="text-light" style="margin-top: 0px">VISITA NUESTRAS REDES SOCIALES</h5>
      <p>
        <a href="https://www.facebook.com/prefecturanavalar" target="_blank" class="pictogramapie"><i class="fa fa-facebook-official"></i></a>
        <a href="https://twitter.com/PrefecturaNaval" target="_blank" class="pictogramapie"><i class="fa fa-twitter-square"></i></a>
        <a href="https://www.youtube.com/c/prefecturanavalar" target="_blank" class="pictogramapie" style="font-size: 24px"><i class="icono-arg-youtube"></i></a>
        <a href="https://www.instagram.com/prefecturanaval/" target="_blank" class="pictogramapie"><i class="fa fa-instagram"></i></a>
      </p>
    </div>
    
    <div class="col-md-3">
		<p><a class="textopie" href="index.html">INICIO</a></p> 
		<p><a class="textopie" href="institucional.html">INSTITUCIONAL</a></p>
		<p><a class="textopie" href="carreras.php">CARRERAS</a></p>
		<p><a class="textopie" href="academica.html">ACADÉMICA</a></p>		
		<p><a class="textopie" href="posgrado.html">POSGRADO</a></p>
		<p><a class="textopie" href="extension.html">EXTENSIÓN</a></p>
		<p><a class="textopie" href="investigacion.html">INVESTIGACIÓN</a></p>
	<!--	<p class="textopie" href="http://www.biblioteca.prefecturanaval.gov.ar/">BIBLIOTECA</p> -->
		<p><a class="textopie" href="revista/index.html" target="_blank">REVISTA</a></p>
		<p><a class="textopie" href="ubicacion.html">UBICACIÓN</a></p>
